...
| separator | String |  |  | -- so you are not obliged to mention it

| allowEmptyStream | boolean | Yes | false | -- so you are not obliged to mention it

| autospanLine | boolean | Yes | false | -- so you are not obliged to mention it

| crlf | String | Yes | WINDOWS | -- so you are not obliged to mention it

| endWithLineBreak | boolean | Yes | true | -- so you are not obliged to mention it

| generateHeaderColumns | boolean | Yes | false | -- so you are not obliged to mention it

| isOrdered | boolean | Yes | false | -- so you are not obliged to mention it

| name | String | Yes |  | -- so you are not obliged to mention it

| quote | String | Yes | " | -- so you are not obliged to mention it

| quoting | boolean | Yes | false | -- so you are not obliged to mention it

| quotingEscaped | boolean | Yes | false | -- so you are not obliged to mention it

| removeQuotes | boolean | Yes | true | -- so you are not obliged to mention it

| skipField | boolean | Yes | false | -- so you are not obliged to mention it

| skipFirstLine | boolean | Yes | false | -- so you are not obliged to mention it
...
| linkType | LinkType | Yes | OneToOne | -- so you are not obliged to mention it
